            ...
            <Scroll html style={{ width: "100%" }}>
              <div className="relative h-[600vh]">
                <main className="flex flex-col relative min-h-[500vh]">
                  ...
                  <section className="relative w-[100%] mb-[1500px]">
                    <div className="max-w-[1240px] mt-[0px] mb-[0px] ml-[auto] mr-[auto] ">
                      ...
                      <p className="max-w-[500px] text-[#e4e4e4]">
                        A magic axe is a mystical weapon imbued with
                        supernatural powers, often found in fantasy worlds. Its
                        blade gleams with an otherworldly light, sometimes
                        glowing with runes or enchanted symbols etched into the
                        metal. The handle may be crafted from ancient wood,
                        dragon bone, or rare enchanted materials, granting the
                        wielder enhanced strength, precision, or magical
                        abilities.
                      </p>
                    </div>
                  </section>
                  <section className=" relative">
                    <div className="max-w-[1240px] mt-[0px] mb-[0px] ml-[auto] mr-[auto] w-[100%] flex items-end flex-col">
                      ...
                      <p className="max-w-[500px] text-[#e4e4e4] text-right">
                        We create different kinds of weapons for our clients.
                        Since 2002 we left 1000+ clients satisfied. Our mission
                        is to make a weapon world better and fullfilled with
                        more quality. You can help us do this! Order your
                        personal axe right now!
                      </p>
                    </div>
                  </section>
                </main>
